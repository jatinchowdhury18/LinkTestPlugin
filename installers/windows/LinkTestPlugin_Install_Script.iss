...
#define MyAppName "LinkTestPlugin"
...
LicenseFile=../../LICENSE
OutputBaseFilename="LinkTestPlugin-Win-{#MyAppVersion}"
OutputDir=.
...
[Files]
Source: "../../bin/Win64/LinkTestPlugin.vst3"; Excludes: "*.aaxplugin,*.clap"; DestDir: "{code:GetDir|VST3_64}"; Components: VST3_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win64/LinkTestPlugin.clap"; Excludes: "*.aaxplugin,*.vst3"; DestDir: "{code:GetDir|CLAP_64}"; Components: CLAP_64; Flags: ignoreversion recursesubdirs createallsubdirs
; Source: "../../bin/Win64/LinkTestPlugin.dll"; Excludes: "*.vst3,*.aaxplugin,*.clap"; DestDir: "{code:GetDir|VST_64}"; Components: VST_64; Flags: ignoreversion recursesubdirs createallsubdirs
; Source: "../../bin/Win64/LinkTestPlugin.exe"; Excludes: "*.vst3,*.aaxplugin,*.clap"; DestDir: "{code:GetDir|Standalone}"; Components: Standalone; Flags: ignoreversion recursesubdirs createallsubdirs
; Source: "../../bin/Win64/LinkTestPlugin.aaxplugin"; Excludes: "*.vst3,*.clap"; DestDir: "{code:GetDir|AAX}"; Components: AAX; Flags: ignoreversion recursesubdirs createallsubdirs

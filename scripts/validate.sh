...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    declare -a plugins=("build/LinkTestPlugin_artefacts/VST3/LinkTestPlugin.vst3")
else
    pluginval=$(install_pluginval_win)
    declare -a plugins=("build/LinkTestPlugin_artefacts/Release/VST3/LinkTestPlugin.vst3")
fi
